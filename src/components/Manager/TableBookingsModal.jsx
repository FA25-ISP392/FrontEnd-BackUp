  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
      <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden border border-orange-200">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="border border-neutral-300 rounded-lg px-3 py-1 text-sm bg-white shadow-sm
                            hover:border-neutral-400 focus:outline-none focus:ring-2 focus:ring-orange-500
        ...
        <div className="p-0">
          {loading ? (
            <div className="p-6 text-neutral-500 text-center">Đang tải...</div>
