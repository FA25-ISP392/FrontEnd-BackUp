      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 overflow-hidden">
        <div className="bg-gradient-to-r from-neutral-50 to-neutral-100 px-6 py-4 border-b border-neutral-200">
          <div className="grid grid-cols-5 gap-4 text-sm font-semibold text-neutral-700">
            ...
            <div className="truncate">Số Người</div>
            <div className="truncate">Thời Gian</div>
        ...
        <div className="divide-y divide-neutral-200">
          {loading ? (
            ...
            <div className="p-6 text-neutral-500">Chưa có yêu cầu đặt bàn nào.</div>
          ) : (
            bookings.map((booking) => {
              const isDeleting = deletingIds.has(Number(booking.id));
