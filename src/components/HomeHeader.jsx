  ...
  const handleReservationSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setNotification(
          "Sorry, all tables are fully reserved for this time slot."
        );
      }
    } catch (error) {
      setNotification(
        "Booking system is currently unavailable. Please call us directly."
      );
    }
  };
            ...
            <div className="p-6 space-y-6">
              <div className="space-y-4 animate-fadeIn">
                <p className="text-neutral-600 leading-relaxed">
                  ...
                  thực hòa quyện cùng sự hiếu khách nồng ấm. Trong hơn một thập
              ...
              <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-lg p-4 border border-orange-200">
                ...
                <p className="text-orange-700 text-sm">
                  ...
                  tuyệt hảo, dịch vụ xuất sắc và sự hiếu khách nồng ấm.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="fixed inset-0 z-50 flex">
          ...
          <div className="relative ml-auto w-full max-w-md bg-white shadow-xl">
            <div className="flex items-center justify-between p-4 border-b">
              <h2 className="text-lg font-semibold">Đặt Bàn</h2>
              <button
                onClick={() => setIsReservationOpen(false)}
              ...
              {notification && (
                <div
                  className={`p-3 rounded-lg text-sm ${
                    notification.includes("confirmed") ||
                    notification.includes("contact")
            ...
            <div className="p-6">
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg p-4 mb-6 border border-blue-200">
                <p className="text-blue-800 font-medium">
                  🍽️ Browse our delicious menu! To place orders, please visit
                  our restaurant and scan the QR code at your table.
                </p>
              </div>
