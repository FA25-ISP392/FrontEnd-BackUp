...
import { X, Calendar, Clock, Users, MapPin, CheckCircle, XCircle, AlertCircle } from "lucide-react";
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold text-gray-900">Lịch sử đặt bàn</h2>
            <button
              onClick={onClose}
          ...
          {!loading && !error && bookings.length === 0 && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-500">
                Bạn chưa có lịch sử đặt bàn nào. Hãy thử đặt bàn để trải nghiệm dịch vụ của chúng tôi!
              </p>
            </div>
          )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {booking.preferredTable && (
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm text-gray-500">Bàn ưa thích</p>
                          <p className="font-medium text-gray-900">
